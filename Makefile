...
manager: generate fmt vet
	go build -mod=vendor -o cmd/manager/manager cmd/manager/main.go
...
manifests: controller-gen
	$(CONTROLLER_GEN) $(CRD_OPTIONS) rbac:roleName=manager-role webhook paths="./internal/api/v1alpha1" output:crd:artifacts:config=config/crd/bases
...
generate: controller-gen
	$(CONTROLLER_GEN) object:headerFile="hack/boilerplate.go.txt" paths="./internal/api/v1alpha1"
